    ...
    <div class="max-w-7xl mx-auto space-y-8 pb-12">
        ...
        >
            ...
            <div x-show="!loading && savedBooks.length === 0"
                ...
                <a href="{{ route('home') }}" class="mt-8 px-6 py-3 bg-brand-primary text-white text-sm font-bold rounded-full hover:bg-opacity-90 transition transform hover:-translate-y-1 shadow-lg">Jelajahi Katalog</a>
            </div>
