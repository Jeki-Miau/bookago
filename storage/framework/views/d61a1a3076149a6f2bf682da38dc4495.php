...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1893174353-0', $__key);
                ...
                <div x-data="{ open: false }" class="relative inline-block text-left">
                    <button @click="open = !open" type="button"
                        ...
                        <img class="w-10 h-10 rounded-full shadow-md border-2 border-white flex-shrink-0 object-cover group-hover:border-brand-lime transition"
                            src="<?php echo e(Auth::user()->avatar ?? 'https://ui-avatars.com/api/?name=' . urlencode(Auth::user()->name) . '&background=0f172a&color=fff'); ?>"
                            alt="Avatar">
                        <span class="ml-3 hidden sm:block"><?php echo e(Auth::user()->name); ?></span>
                    ...
                    <div x-show="open" @click.away="open = false" x-transition.opacity
                        ...
                        <div class="px-4 py-3 border-b border-gray-50 bg-gray-50/50">
                            ...
                            <p class="text-sm font-bold text-brand-dark truncate"><?php echo e(Auth::user()->email); ?></p>
                        </div>
                        <div class="py-1">
                            ...
                            <a href="<?php echo e(route('profile.edit')); ?>"
                                ...
                                Akun</a>
                            <form method="POST" action="<?php echo e(route('logout')); ?>" class="border-t border-gray-50 mt-1">
                                <?php echo csrf_field(); ?>
                                <button type="submit"
...
</header><?php /**PATH C:\Users\Jeki\Herd\bookago\resources\views/components/navbar.blade.php ENDPATH**/ ?>