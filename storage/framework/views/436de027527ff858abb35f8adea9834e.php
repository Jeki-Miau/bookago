...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="max-w-4xl mx-auto space-y-8 pb-12">
        ...
        <section x-data="{ 
                show: false,
                imagePreview: '<?php echo e($user->avatar ?? "https://ui-avatars.com/api/?name=" . urlencode($user->name) . "&background=0f172a&color=fff"); ?>',
                updatePreview(event) {
            ...
            <form action="<?php echo e(route('profile.update')); ?>" method="POST" enctype="multipart/form-data" class="divide-y divide-gray-100">
                <?php echo csrf_field(); ?>
                ...
                <div class="p-6 lg:p-8 flex flex-col sm:flex-row gap-8 items-start sm:items-center">
                    ...
                    <div class="space-y-1">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['avatar_file'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div>
                        ...
                        <div class="flex items-center space-x-3 w-full bg-gray-100 border border-gray-200 rounded-xl px-4 py-3 opacity-70">
                            ...
                            <span class="text-sm font-semibold text-gray-600"><?php echo e($user->email); ?></span>
                        </div>
                    ...
                    <div>
                        ...
                        <textarea name="bio" id="bio" rows="4" 
                            class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm font-semibold text-brand-dark focus:ring-2 focus:ring-brand-lime focus:border-brand-lime transition" placeholder="Ceritakan sedikit mengenai hobi membaca atau gelar akademik Anda..."><?php echo e(old('bio', $user->bio)); ?></textarea>
...
<?php endif; ?>
<?php /**PATH C:\Users\Jeki\Herd\bookago\resources\views/profile/edit.blade.php ENDPATH**/ ?>