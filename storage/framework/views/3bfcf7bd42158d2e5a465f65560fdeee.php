...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin-layout','data' => ['title' => 'Admin Dashboard - BOOKAGO']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Admin Dashboard - BOOKAGO']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
                    ...
                    <div class="stat-card bg-white rounded-xl p-5 shadow-sm border border-gray-100 hover-lift group">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-2xl font-black text-brand-dark"><?php echo e($stats['users']); ?></p>
                            </div>
                    ...
                    <div class="stat-card bg-white rounded-xl p-5 shadow-sm border border-gray-100 hover-lift group">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-2xl font-black text-brand-dark"><?php echo e($stats['discussions']); ?></p>
                            </div>
                    ...
                    <div class="stat-card bg-white rounded-xl p-5 shadow-sm border border-gray-100 hover-lift group">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-2xl font-black text-brand-dark"><?php echo e($stats['replies']); ?></p>
                            </div>
                    ...
                    <div class="stat-card bg-white rounded-xl p-5 shadow-sm border border-gray-100 hover-lift group">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-2xl font-black text-brand-dark"><?php echo e($stats['activeAnnouncements']); ?></p>
                            </div>
                    ...
                    <div class="stat-card bg-white rounded-xl p-5 shadow-sm border border-gray-100 hover-lift group">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-2xl font-black text-brand-dark"><?php echo e($stats['unreadMessages']); ?></p>
                            </div>
                    ...
                    <div class="stat-card bg-white rounded-xl p-5 shadow-sm border border-gray-100 hover-lift group">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-2xl font-black text-brand-dark"><?php echo e($stats['activeWarnings']); ?></p>
                            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    <div x-data="{ show: false }" x-init="setTimeout(() => show = true, 700)" x-show="show" x-transition:enter="transition ease-out duration-700" x-transition:enter-start="opacity-0 translate-y-8" x-transition:enter-end="opacity-100 translate-y-0" class="bg-white rounded-xl p-6 shadow-sm border border-gray-100 hover-lift">
                        ...
                        <div class="grid grid-cols-1 gap-3">
                            <a href="<?php echo e(route('admin.announcements.create')); ?>" class="flex items-center justify-between px-4 py-3 bg-brand-primary text-white rounded-lg font-semibold hover:bg-brand-dark transition hover:-translate-y-1 shadow-sm group">
                            ...
                            <a href="<?php echo e(route('admin.warnings.create')); ?>" class="flex items-center justify-between px-4 py-3 bg-red-500 text-white rounded-lg font-semibold hover:bg-red-600 transition hover:-translate-y-1 shadow-sm group">
                                <div class="flex items-center">
                                    <svg class="w-5 h-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"></path>
                                    </svg>
                            ...
                            <a href="<?php echo e(route('admin.messages')); ?>" class="flex items-center justify-between px-4 py-3 bg-brand-lime text-white rounded-lg font-semibold hover:bg-brand-primary transition hover:-translate-y-1 shadow-sm group">
                                <div class="flex items-center">
                                    <svg class="w-5 h-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                                    </svg>
                    ...
                    <div x-data="{ show: false }" x-init="setTimeout(() => show = true, 800)" x-show="show" x-transition:enter="transition ease-out duration-700" x-transition:enter-start="opacity-0 translate-y-8" x-transition:enter-end="opacity-100 translate-y-0" class="bg-white rounded-xl p-6 shadow-sm border border-gray-100 hover-lift">
                        ...
                        <div class="space-y-2">
                            <a href="<?php echo e(route('forum.index')); ?>" class="flex items-center justify-between px-4 py-2.5 bg-gray-50 rounded-lg hover:bg-brand-lime/10 transition group border border-gray-100">
                            ...
                            <a href="<?php echo e(route('home')); ?>" class="flex items-center justify-between px-4 py-2.5 bg-gray-50 rounded-lg hover:bg-brand-lime/10 transition group border border-gray-100">
                                <span class="font-semibold text-brand-dark">Katalog Buku</span>
                                <svg class="w-5 h-5 text-gray-400 group-hover:text-brand-lime group-hover:translate-x-1 transition" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                                </svg>
                            </a>
                            <a href="<?php echo e(route('admin.users')); ?>" class="flex items-center justify-between px-4 py-2.5 bg-gray-50 rounded-lg hover:bg-brand-lime/10 transition group border border-gray-100">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div x-data="{ show: false }" x-init="setTimeout(() => show = true, 900)" x-show="show" x-transition:enter="transition ease-out duration-700" x-transition:enter-start="opacity-0 translate-y-8" x-transition:enter-end="opacity-100 translate-y-0" class="bg-white rounded-xl p-6 shadow-sm border border-gray-100 hover-lift">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($recentDiscussions->count() > 0): ?>
                            <div class="space-y-3">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $recentDiscussions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $discussion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <div class="flex items-center justify-between py-2 border-b border-gray-50 hover:bg-gray-50 rounded-lg px-2 -mx-2 transition">
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div>
                                            <p class="font-semibold text-brand-dark text-sm line-clamp-1"><?php echo e($discussion->title); ?></p>
                                            <p class="text-xs text-gray-500">by <?php echo e($discussion->user->name); ?></p>
                                        </div>
                                    </div>
                                    <a href="<?php echo e(route('forum.show', $discussion->slug)); ?>" class="text-brand-lime hover:text-brand-primary text-sm font-semibold hover:translate-x-1 transition">Lihat</a>
                                </div>
                    ...
                    <div x-data="{ show: false }" x-init="setTimeout(() => show = true, 1000)" x-show="show" x-transition:enter="transition ease-out duration-700" x-transition:enter-start="opacity-0 translate-y-8" x-transition:enter-end="opacity-100 translate-y-0" class="bg-white rounded-xl p-6 shadow-sm border border-gray-100 hover-lift">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($recentMessages->count() > 0): ?>
                            <div class="space-y-3">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $recentMessages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <div class="flex items-center justify-between py-2 border-b border-gray-50 hover:bg-gray-50 rounded-lg px-2 -mx-2 transition">
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div>
                                            <p class="font-semibold text-brand-dark text-sm line-clamp-1"><?php echo e($message->subject); ?></p>
                                            <p class="text-xs text-gray-500">from <?php echo e($message->user->name); ?></p>
                                        </div>
                                    </div>
                                    <a href="<?php echo e(route('admin.messages.show', $message->id)); ?>" class="text-brand-lime hover:text-brand-primary text-sm font-semibold hover:translate-x-1 transition">Lihat</a>
                                </div>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                            </div>
                        <?php else: ?>
...
<?php endif; ?><?php /**PATH C:\Users\Jeki\Herd\bookago\resources\views/admin/dashboard/index.blade.php ENDPATH**/ ?>