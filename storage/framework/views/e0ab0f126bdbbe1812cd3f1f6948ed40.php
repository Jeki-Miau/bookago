...
<head>
    ...
    <title><?php echo e(config('app.name', 'BOOKAGO')); ?> - Perpustakaan Digital</title>
...
<body class="bg-white text-brand-dark antialiased selection:bg-brand-lime selection:text-white overflow-x-hidden">
    ...
    <div class="pill-navbar" id="pillNavbar" x-data="{
        ...
        <div class="pill-inner flex items-center justify-between gap-1 w-full max-w-full">
            ...
            <div class="hidden md:flex items-center gap-1.5">
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="pill-nav-link text-gray-600">Masuk</a>
    ...
    <footer class="bg-brand-footer pt-16 pb-8 border-t border-brand-dark/20 relative">
        ...
        <div
            ...
            <p>© <?php echo e(date('Y')); ?> BOOKAGO Nusantara. Dibuat dengan ❤️ di Indonesia.</p>
...
</html><?php /**PATH C:\Users\Jeki\Herd\bookago\resources\views/components/guest-layout.blade.php ENDPATH**/ ?>