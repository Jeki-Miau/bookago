        ...
        <section class="space-y-6 pt-6">
            <div class="flex items-center justify-between border-b border-gray-100 pb-4">
                <h2 class="text-2xl font-extrabold flex items-center space-x-3">
                    ...
                    <span class="text-brand-dark">Hasil Pencarian: <span class="text-brand-primary">"<?php echo e($query); ?>"</span></span>
                </h2>
                <a href="<?php echo e(route('home')); ?>" class="text-sm font-bold text-gray-500 hover:text-brand-dark transition inline-flex items-center">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-6 pt-4">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
...
<?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    <div class="col-span-full py-32 flex flex-col items-center justify-center bg-white rounded-3xl border border-gray-100 shadow-sm text-center">
                        ...
                        <p class="text-gray-500 font-medium max-w-sm mt-2">Kami tidak dapat menemukan buku dengan kata kunci "<?php echo e($query); ?>". Coba gunakan kata kunci lain seputar judul, penulis, atau topik.</p>
                        
                        <a href="<?php echo e(route('landing')); ?>" class="mt-8 px-6 py-3 bg-brand-bg border-2 border-brand-primary text-brand-primary text-sm font-bold rounded-full hover:bg-brand-primary hover:text-white transition-all transform hover:-translate-y-1 shadow-sm">Coba Pencarian Baru</a>
                    </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\Jeki\Herd\bookago\resources\views/books/search.blade.php ENDPATH**/ ?>